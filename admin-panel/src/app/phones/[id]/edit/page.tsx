...
export default function EditPhone({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (imageFile) {
        updatedImageUrl = await uploadProductImage(imageFile, "phones");
      }
      ...
      alert("Failed to update phone. See console for details.");
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h2 className="text-2xl font-heading font-bold">Edit Phone</h2>
      </div>
